// reset-test-passwords-lowercase.js
// Resets passwords for existing Supabase Auth users (matching exact case from list)
...
// Test users to reset: email -> new password (using exact case from list)
const testUsers = [
