...
export async function getTelegramSettings(congregationId: string | null): Promise<TelegramSettings> {
  ...
  const row = (data || undefined) as Partial<TelegramSettings> | undefined;
  return {
