...
// GET ?month=YYYY-MM-01            → informes de todos los publicadores de ese mes
// GET ?user_id=...&from=...&to=... → historial de un publicador (rango de meses)
